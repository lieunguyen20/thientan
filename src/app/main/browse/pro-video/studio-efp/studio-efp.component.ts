...
@Component({
  selector: 'app-studio-efp',
  templateUrl: './studio-efp.component.html',
  styleUrls: ['./studio-efp.component.scss']
})
export class StudioEfpComponent implements OnInit {dataRegular: string;
  dataHover: string;
  constructor() { }
