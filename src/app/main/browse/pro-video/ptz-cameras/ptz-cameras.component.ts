...
@Component({
  selector: 'app-ptz-cameras',
  templateUrl: './ptz-cameras.component.html',
  styleUrls: ['./ptz-cameras.component.scss']
})
export class PtzCamerasComponent implements OnInit {dataRegular: string;
  dataHover: string;
  constructor() { }
