...
@Component({
  selector: 'app-degital-cine',
  templateUrl: './degital-cine.component.html',
  styleUrls: ['./degital-cine.component.scss']
})
export class DegitalCineComponent implements OnInit { dataRegular: string;
  dataHover: string;
  constructor() { }
