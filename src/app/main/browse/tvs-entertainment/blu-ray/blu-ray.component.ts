...
@Component({
  selector: 'app-blu-ray',
  templateUrl: './blu-ray.component.html',
  styleUrls: ['./blu-ray.component.scss']
})
export class BluRayComponent implements OnInit { dataRegular: string;
  dataHover: string;
  constructor() { }
